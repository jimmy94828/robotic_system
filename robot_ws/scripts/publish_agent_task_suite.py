...
DEFAULT_TASKS = [
    ...
    "Bring the can from the chair and put it on the desk",
    "Move the can from the desk to the chair.",
    "Grasp the can from the desk and hand it to the person sitting on the chair",
]
