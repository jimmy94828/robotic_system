...
This matches map_alignment_v3.py because it accepts idx,x,y plus yaw or yaw_rad.
"""
...
def convert_folder(
    ...
    for txt_path in files:
        try:
            ...
            if include_t_sec:
                row = {"idx": idx, "t_sec": timestamp, "x": x, "y": y, output_yaw_col: yaw}
            rows.append(row)
...
def main() -> None:
    ...
    ap.add_argument(
        ...
        default="yaw_rad",
        choices=["yaw_rad", "yaw"],
        help="map_alignment_v3.py accepts either yaw_rad or yaw. Default: yaw_rad.",
    )
    ap.add_argument("--include_t_sec", action="store_true", help="Also write timestamp from filename as t_sec.")
    ...
    convert_folder(
        ...
        include_t_sec=args.include_t_sec,
        strict=args.strict,
    )
