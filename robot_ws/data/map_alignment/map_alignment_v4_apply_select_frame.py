...
def main():
    ...
    # search best extrinsic interpretation using selected-frame mapping:
    # selected.pose3d_idx -> pose3d.idx, selected.origin_idx -> pose2d.idx.
    best = None
    ...
    # report
    print(f"[best] extrinsic={best['tag']}, selected_frames={args.selected_frames}, matched={best['n_all']}, inliers={best['n_in']}, rmse={best['err']:.4f}")
