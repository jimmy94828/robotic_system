...
static const _ObjectDetection_type_support_symbol_names_t _ObjectDetection_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, kachaka_interfaces, msg, ObjectDetection)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, kachaka_interfaces, msg, ObjectDetection)),
  }
};
...
{
  return &::kachaka_interfaces::msg::rosidl_typesupport_cpp::ObjectDetection_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, kachaka_interfaces, msg, ObjectDetection)() {
  return get_message_type_support_handle<kachaka_interfaces::msg::ObjectDetection>();
}
