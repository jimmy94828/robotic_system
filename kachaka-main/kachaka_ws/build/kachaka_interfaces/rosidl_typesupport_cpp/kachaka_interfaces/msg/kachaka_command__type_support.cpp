...
static const _KachakaCommand_type_support_symbol_names_t _KachakaCommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, kachaka_interfaces, msg, KachakaCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, kachaka_interfaces, msg, KachakaCommand)),
  }
};
...
{
  return &::kachaka_interfaces::msg::rosidl_typesupport_cpp::KachakaCommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, kachaka_interfaces, msg, KachakaCommand)() {
  return get_message_type_support_handle<kachaka_interfaces::msg::KachakaCommand>();
}
